...
transition(name='slide-fade')
  div(v-if='message' class='absolute bottom-5 left-0 right-0 ml-auto mr-auto flash-message rounded p-4 flex justify-center items-center w-min whitespace-nowrap')
    svg-icon(iconName='check_circle_outline' size='24' class='text-brand mr-2.5')
    div(class='text-primary' v-html='message')

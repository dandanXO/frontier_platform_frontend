<template lang="pug">
div(v-if="isModalConfirmOpen" class="fixed inset-0 z-20 w-screen h-screen bg-black-900 bg-opacity-70 flex justify-center items-center")
  div(class="w-100 bg-black-0")

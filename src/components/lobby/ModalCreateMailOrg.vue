...
div(class="w-100 px-8")
  h6(class="text-h6 text-primary font-bold text-center pb-4") {{$t('a.createUploadMail')}}
  p(class="text-body2 text-primary line-height-1.6 text-center pb-4") {{$t('a.createMailForOrg')}}

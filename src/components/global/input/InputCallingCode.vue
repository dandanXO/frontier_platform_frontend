<template lang="pug">
input-text(v-model:textValue="innerTextValue" :size="size" ref="refContainer")
  template(#prependItem)
    div(class="h-full -ml-4 pr-3 flex")
      popper(placement="bottom-start" @expand="expand")
        ...
        template(#content)
          div(class="py-2 bg-black-0 border rounded border-primary-middle card-shadow" :style="{ width: contentWidth + 'px' }")
            overlay-scrollbar-container(:style="{ 'max-height': 36 * maxLength + 'px' }")
              div(

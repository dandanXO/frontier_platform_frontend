  ...
  template(#content)
    div(class="w-full h-full text-center pt-23")
      ...
      div(class="w-fit h-80.5 grid grid-cols-2 gap-14.5 mx-auto")
        div(class="w-64.5 border border-primary-middle rounded card-shadow overflow-hidden flex flex-col")
          div(class="h-1.5 bg-primary-middle")
          div(class="flex-grow h-auto pt-9 pb-7.5 flex flex-col justify-between items-center")
            h4(class="text-h4 text-primary text-normal mb-4") {{ $t("OO0174") }}
            ...
            div(class="flex flex-col w-fit")
              ...
              h3(class="text-h3 font-medium text-primary mb-3") {{ $t("OO0174") }}

...
export const handlers = [
  ...
  rest.post(BASE_URL + '/user/old-user/reset-password', mockUser.oldUserResetPassword),
  ...
  rest.post(BASE_URL + '/org/group/delete', deserializeUser(mockGroup.deleteGroup)),

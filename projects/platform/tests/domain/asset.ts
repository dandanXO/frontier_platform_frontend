...
export class AssetPage {
  ...
  clickUploadPageIcon = () => this.page.locator('[data-cy="upload-page"]').click()
  clickMassUploadBtn = () => this.page.locator('[data-cy="mass-upload"]').click()
  clickSmartUploadBtn = () => this.page.locator('[data-cy="smart-upload"]').click()
  clickManualUploadBtn = () => this.page.locator('[data-cy="manual-upload"]').click()
  clickBrowseFileBtn = () =>
  ...
  uploadErrorElement = () => this.page.locator('[data-cy="modal-mass-upload_error"]')

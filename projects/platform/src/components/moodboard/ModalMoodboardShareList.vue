    ...
    div
      ...
      f-scrollbar-container(class="max-h-67 -mx-4 px-4")
        div(class="grid gap-y-1")
          div(v-for="shareTarget in shareList" class="group flex items-center h-12 pl-2 pr-4 gap-x-4 hover:bg-grey-100")
            ...
            p(class="text-body2 text-red-400 cursor-pointer invisible group-hover:visible" @click="removeMoodboardShare(shareTarget)") {{ $t('UU0016') }}
</template>

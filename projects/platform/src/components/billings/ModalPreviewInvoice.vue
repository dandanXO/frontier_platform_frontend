...
div( class="w-149 h-194")
      ...
      div(class="flex items-center mb-4")
        ...
        invoice-pdf-generator
          template(#activator="{ generatePdf }")
            div(class="flex items-center text-cyan-400 cursor-pointer" @click="generatePdf(innerInvoice.invoiceId)")
  ...
  div(class="relative")
    ...
    f-scrollbar-container(class="h-77.5 px-8 my-5")
      div(class="flex flex-col gap-2.5")
        div(v-for="item in innerInvoice.serviceItemList" class="flex text-caption text-grey-900")
          div(style="width: 50%")
  ...
  div(class="px-8 mt-3 flex justify-between")
    ...
    div(class="relative h-full")
      ...
      div(class="absolute -right-8 top-14.5 w-60 py-2 px-10 bg-primary-0 text-grey-900 text-body2")
  ...
  div(class="px-8 text-caption w-fit ml-auto mt-13.5 mb-7.5")
    div(class="inline-block mr-6")
      ...
      span(class="text-grey-600") +886-2-27528855
    div(class="inline-block")
      span(class="font-bold text-grey-600 mr-1") {{ $t("OO0098") }}:
      span(class="text-grey-600") info@frontier.cool
    div(class="text-grey-600 mt-3") Fuxing N. Rd., Suite 7-3, Taipei City, Taiwan
</template>

...
div
  div(
    ...
    div(class="flex flex-col justify-between pb-5")
      ...
      div(class="text-caption" :class="{ 'text-grey-250': service.planStatus.INVALID }")
...
import { VALUE_ADDED_SERVICE_STATUS, useConstants } from '@/utils/constants'
...
const goTo = (service: string, tagId: number) => {
  router.push({
    name: route.name!,

  ...
  template(#content)
    div(class="w-full h-full text-center pt-23")
      ...
      div(class="w-fit h-80.5 grid grid-cols-2 gap-14.5 mx-auto")
        div(class="w-64.5 border border-grey-150 rounded card-shadow overflow-hidden flex flex-col")
      ...
      p(class="mt-25 text-cyan-400 text-body2 cursor-pointer" @click="openModalPlanIntroduction") {{ $t('OO0068') }}
</template>

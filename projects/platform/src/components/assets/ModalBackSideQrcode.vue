...
modal-behavior(
  ...
  div(class="w-104")
    i18n-t(keypath="DD0010" tag="div" class="mb-7.5 text-body2 text-grey-900 leading-1.6" scope="global")
      template(#DD0111)
        div(class="inline-flex items-center text-cyan-400 cursor-pointer" @click="printBackSideLabel") {{ $t("DD0111") }}

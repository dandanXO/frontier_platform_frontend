    ...
    div(class="flex flex-col gap-y-2")
      ...
      div(class="flex items-center gap-x-5")
        ...
        span(class="flex items-center gap-x-1 cursor-pointer")
          f-svg-icon(iconName="info_outline" size="20" class="text-primary")
        ...
        div(class="w-52.5")
          ...
          div(class="grid gap-y-3")
            div(v-for="pantone in material.pantoneList" class="flex items-center gap-x-3")
              ...
              f-svg-icon(iconName="clear" size="20" class="text-black-500 cursor-pointer" @click="removePantone(pantone.materialPantoneId)")

...
export default {
  ...
  components: {
    ...
    ModalMoodboardCollectionDetail: defineAsyncComponent(() => import('@/components/moodboard/ModalMoodboardCollectionDetail.vue')),
    ...
    ModalUploadFileGeneral: defineAsyncComponent(() => import('@/components/common/ModalUploadFileGeneral.vue')),
    ...
    ModalUploadThumbnail: defineAsyncComponent(() => import('@/components/common/ModalUploadThumbnail.vue')),

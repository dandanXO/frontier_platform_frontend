...
div(
  ...
  class="flex items-center py-4 md:pt-12 md:pb-9"
)
  slot(name="slot:logo")
...
div(class="pb-1 md:pb-4" :class="{ 'md:pt-5': breadcrumbList.length <= 1 }")
  div(class="flex items-center pb-1 gap-x-4")
    h5(class="text-body1 md:text-h5 text-grey-900 font-bold leading-1.6 break-words") {{ `${material.materialNo} ${material.description}` }}

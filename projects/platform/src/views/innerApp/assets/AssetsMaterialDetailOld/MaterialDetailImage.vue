...
import Slider from '@/views/innerApp/assets/AssetsMaterialDetailOld/Slider.vue'
import type { THEME } from '@frontier/lib'
import type { MenuTree } from '@frontier/ui-component'
import type { CoverId, MaterialFile } from '@/types'
import FileThumbnail from '@/views/innerApp/assets/AssetsMaterialDetailOld/FileThumbnail.vue'
import FileDisplay from '@/views/innerApp/assets/AssetsMaterialDetailOld/FileDisplay.vue'
...
import LowDpiLabel from '@/views/innerApp/assets/AssetsMaterialDetailOld/LowDpiLabel.vue'
// 預防edge case暫存上一個選擇

...
import MaterialDetailImage from '@/views/innerApp/assets/AssetsMaterialDetailOld/MaterialDetailImage.vue'
import MaterialDetailSpecification from '@/views/innerApp/assets/AssetsMaterialDetailOld/MaterialDetailSpecification.vue'
import MaterialDetailColorAndPattern from '@/views/innerApp/assets/AssetsMaterialDetailOld/MaterialDetailColorAndPattern.vue'

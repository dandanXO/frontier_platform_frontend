  ...
  div(class="w-230 h-fit pb-25")
    ...
    div(class="pb-7.5")
      div(class="flex items-center pb-2")
        ...
        f-tooltip
          template(#trigger)
            f-svg-icon(iconName="clone" class="text-grey-600 cursor-pointer hover:text-primary-400" size="24" @click="shareToMeCloneByMaterial(nodeKey, sharingId, share.isCanClone)")
          template(#content)
            p {{ $t("RR0056") }}

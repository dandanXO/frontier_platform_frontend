...
export const FUNC_ID = {
  ...
  WORKSPACE_CAN_SELLECT: 39,
  CUSTOM_FIELD_EDIT: 40,
}
...
const GUEST_PERMISSION_LIST = [FUNC_ID.WORKSPACE_CAN_SELLECT] // not have any permission

const MANAGER_PERMISSION_LIST = [FUNC_ID.HIDE_SHOW_WORKFLOW_STAGE]

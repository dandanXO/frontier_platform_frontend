...
export default {
  ...
  actions: {
    ...
    async createMoodboardNodeCollection ({ dispatch, commit }, params) {
      ...
      const { data } = await dispatch('callMoodboardApi', { func: 'createMoodboardNodeCollection', params: tempParams })
      commit('SET_moodboardOfferNodeCollection', data.result.moodboardOfferNodeCollection)
    },
    ...
    async updateMoodboardNodeCollection ({ dispatch }, params) {
      ...
      await dispatch('callMoodboardApi', { func: 'updateMoodboardNodeCollection', params: tempParams })
    },

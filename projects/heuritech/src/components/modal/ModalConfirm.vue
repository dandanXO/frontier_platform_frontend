...
const primaryHandler = async () => {
  ...
  props.closeAfterPrimaryBtnHandler && modalStore.closePipeline()
...
const secondaryHandler = async () => {
  ...
  props.closeAfterSecondaryBtnHandler && modalStore.closePipeline()
...
const textHandler = async () => {
  ...
  props.closeAfterTextBtnHandler && modalStore.closePipeline()

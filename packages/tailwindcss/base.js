const defaultLightTheme = (theme) => ({
  ...
  '--color-critical-text': theme('colors.red.500.v1'),
  ...
  '--color-secondary-hover': theme('colors.grey.100.v1'),
  '--color-tertiary': theme('colors.grey.100.v1'),
  '--color-tertiary-text': theme('colors.grey.600.v1'),
  '--color-tertiary-border': theme('colors.grey.50.v1'),
...
module.exports = function ({ addBase, theme }) {
  addBase({
    ':root': {
      ...
      '--color-secondary': theme('colors.grey.100.DEFAULT'),
    ...
    '[data-theme="new-dark"]': {
      ...
      '--color-critical-text': theme('colors.red.400.v1'),
      '--color-link': theme('colors.cyan.500.v1'),
      '--color-link-hover': theme('colors.cyan.600.v1'),
      ...
      '--color-secondary-hover': theme('colors.grey.800.v1'),
      '--color-secondary-text': theme('colors.grey.300.v1'),
      '--color-tertiary': theme('colors.grey.800.v1'),
      '--color-tertiary-text': theme('colors.grey.300.v1'),
      '--color-tertiary-border': theme('colors.grey.900.v1'),
